...
def load(batch_size, test_batch_size, datapath, include_targets=False, n_labelled=None, rs=np.random):
    train_gen, dev_gen, test_gen = tflib.mnist.load(batch_size, test_batch_size, datapath, n_labelled, rs=rs)
    return (
